package com.luhanlin.netty.io.bio.tomcat;
...
public class LUTomcat {
    private int port = 8080;
    private ServerSocket server;
    private Map<String, LUServlet> servletMapping = new HashMap<String,LUServlet>();
        ...
        try{
            ...
            for (Object k : webxml.keySet()) {
                ...
                if(key.endsWith(".url")){
                    ...
                    //单实例，多线程
                    LUServlet obj = (LUServlet)Class.forName(className).newInstance();
    ...
    public void start(){
        ...
        try {
            ...
            System.out.println("LU Tomcat 已启动，监听的端口是：" + this.port);
    ...
    private void process(Socket client) throws Exception {
        ...
        LURequest request = new LURequest(is);
        LUResponse response = new LUResponse(os);
